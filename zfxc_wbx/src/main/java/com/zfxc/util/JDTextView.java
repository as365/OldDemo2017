...
public class JDTextView extends TextView {
	...
	public JDTextView(Context context, AttributeSet attrs) {
		...
		TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.JDTextView);

		float textsize = typedArray.getDimension(R.styleable.JDTextView_textSize, 20);
		int textcolor = typedArray.getColor(R.styleable.JDTextView_textColor, -1442840576);
		float linespace = typedArray.getDimension(R.styleable.JDTextView_lineSpacingExtra, -12);  
		int typeface = typedArray.getColor(R.styleable.JDTextView_typeface, 0);
