...
public class MyDbHelper
	{
		...
		private static int version = 13;//数据库版本号
...
//		  	  db.execSQL("insert into tbwebservicecfg" +  
//		              "(sinnerws,soutterws) values('http://58.62.200.82/gzvpms_webservice_test/Service.asmx','http://58.62.200.82/gzvpms_webservice_test/Service.asmx')"); 
//		  
//		  	    
//		  	  db.execSQL("insert into tbwebservicecfg" +  
//		              "(sinnerws,soutterws) values('http://123.127.160.82/tjzf_webservice/service.asmx','http://123.127.160.82/tjzf_webservice/service.asmx')"); 
//		  	 db.execSQL("insert into tbwebservicecfg" +  
//		              "(sinnerws,soutterws) values('http://123.127.160.82/webservice_tj_zfxc/Service.asmx','http://123.127.160.82/webservice_tj_zfxc/Service.asmx')");
//		  	http://123.127.160.82/webservice_tj_zfxc/Service.asmx
		  	  db.execSQL("insert into tbwebservicecfg" +  
		              "(sinnerws,soutterws) values('http://fxcjd.wghsc.cn/webservice_tj_zfxc/Service.asmx','http://fxcjd.wghsc.cn/webservice_tj_zfxc/Service.asmx')");
		...
		public Cursor select(String table, String[] columns, 
				String selection, String[] selectionArgs, String groupBy, 
				String having, String orderBy,String limited)
		{
		
			Cursor cursor = mDb.query
			(
					table, columns, selection, selectionArgs, 
					groupBy, having, orderBy,limited
			);
		...
		public Cursor select(String sql){
			...
			Cursor rec = mDb.rawQuery(sql, null);  
			return rec;
		}
		/**添加数据*/
