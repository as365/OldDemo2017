...
public static String filename=Environment.getExternalStorageDirectory().getPath()+"/DCIM/Camera/20151029_102917.jpg";
...
//			"http://photo.scol.com.cn/hdp/img/attachement/jpg/site2/20140422/00219b7b064914c05a234b.jpg", };
	...
	public static String[] IMAGES = new String[] {filename};
	/**
	 * 随机产生的一个图片Url
	 * 
	 * @return
